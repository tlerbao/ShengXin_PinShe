<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:31:"./template/pc/lists_recruit.htm";i:1610417268;s:47:"/www/ShengXin/PinSheSite/template/pc/header.htm";i:1630027834;s:47:"/www/ShengXin/PinSheSite/template/pc/banner.htm";i:1610417126;s:47:"/www/ShengXin/PinSheSite/template/pc/footer.htm";i:1611804224;}*/ ?>
<!DOCTYPE html>
<html>
<head>
...
<div class="layout bg-white">
	<div class="container">
		<div class="line nav-bread">
			<div class="x6">
				<h2 class="text-main"><?php echo $eyou['field']['typename']; ?></h2>
			</div>
...
<div class="layout bg-gray">
	...
	<div class="container">
		<div class="line-big">
			<?php  $typeid = "";  if(empty($typeid) && isset($channelartlist["id"]) && !empty($channelartlist["id"])) : $typeid = intval($channelartlist["id"]); endif;  $param = array(      "typeid"=> $typeid,      "notypeid"=> "",      "flag"=> "",      "noflag"=> "",      "channel"=> "",      "keyword"=> "", ); $tagList = new \think\template\taglib\eyou\TagList; $_result_tmp = $tagList->getList($param, 10, "", "gzdd,zprs,xzdy", "desc", "on","off");if(is_array($_result_tmp) || $_result_tmp instanceof \think\Collection || $_result_tmp instanceof \think\Paginator): $i = 0; $e = 1; $__LIST__ = $_result = $_result_tmp["list"]; $__PAGES__ = $_result_tmp["pages"];if( count($__LIST__)==0 ) : echo htmlspecialchars_decode("");else: foreach($__LIST__ as $key=>$field): $aid = $field["aid"];$users_id = $field["users_id"];$field["title"] = text_msubstr($field["title"], 0, 30, false);$field["seo_description"] = text_msubstr($field["seo_description"], 0, 160, true);$i= intval($key) + 1;$mod = ($i % 2 ); ?>
			<div class="x4">
				<a href="<?php echo $field['arcurl']; ?>">
				<dl class="job-list bg-white padding-large margin-big-bottom">
					<dt>
						<p class="text-gray"><?php echo MyDate('Y-m-d',$field['add_time']); ?></p>
						<h2 class="text-main margin-small-top"><?php echo $field['title']; ?></h2>
					</dt>
					<hr class="bg-gray">
					<dd class="text-gray margin-top height-big">
						<p>工作地点：<?php echo $field['gzdd']; ?></p>
						<p>招聘人数：<?php echo $field['zprs']; ?></p>
						<p>薪资待遇：<?php echo $field['xzdy']; ?></p>
						<p class="text-right"><span class="button button-small bg-yellow">详细</span></p>
					</dd>
				</dl>
				</a>
			</div>
