<?php if (!defined('THINK_PATH')) exit(); /*a:5:{s:53:"./application/admin/template/archives/index_draft.htm";i:1635510274;s:67:"/www/ShengXin/YFMJSite/application/admin/template/public/layout.htm";i:1635510274;s:70:"/www/ShengXin/YFMJSite/application/admin/template/public/theme_css.htm";i:1635510274;s:65:"/www/ShengXin/YFMJSite/application/admin/template/public/page.htm";i:1611051758;s:67:"/www/ShengXin/YFMJSite/application/admin/template/public/footer.htm";i:1571728724;}*/ ?>
<!doctype html>
<html>
<head>
                ...
                <table style="width: 100%;">
                    ...
                    <?php else: if(is_array($list) || $list instanceof \think\Collection || $list instanceof \think\Paginator): if( count($list)==0 ) : echo "" ;else: foreach($list as $k=>$vo): ?>
                        <tr>
                            ...
                            <td class="">
                                <div class="w110 tc"><a href="<?php echo url('Archives/index_draft', array('typeid'=>$vo['typeid'])); ?>"><?php echo (isset($vo['typename']) && ($vo['typename'] !== '')?$vo['typename']:'<i class="red">数据出错！</i>'); ?></a></div>
                            </td>
                            <td>
                                <div class="tc w60">
                                    <?php if($vo['arcrank'] == -1): ?>
