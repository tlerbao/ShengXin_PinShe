<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:33:"./template/pc/lists_guestbook.htm";i:1610417244;s:45:"/www/ShengXin/YFMJSite/template/pc/header.htm";i:1630027834;s:45:"/www/ShengXin/YFMJSite/template/pc/banner.htm";i:1610417126;s:45:"/www/ShengXin/YFMJSite/template/pc/footer.htm";i:1611804224;}*/ ?>
<!DOCTYPE html>
<html>
<head>
	...
	<div class="line">
			...
			<div class="contact">
				<div class="media media-x">
					...
					<div class="media-body">
						...
						<p class="text-middle"><?php  $tagGlobal = new \think\template\taglib\eyou\TagGlobal; $__VALUE__ = $tagGlobal->getGlobal("web_attr_16"); echo $__VALUE__; ?><p>
					</div>
				</div>
				...
				<div class="media media-x">
					...
					<div class="media-body">
						...
						<p class="text-large Conv_DINCondensedC"><a href="tel:<?php  $tagGlobal = new \think\template\taglib\eyou\TagGlobal; $__VALUE__ = $tagGlobal->getGlobal("web_attr_1"); echo $__VALUE__; ?>"><?php  $tagGlobal = new \think\template\taglib\eyou\TagGlobal; $__VALUE__ = $tagGlobal->getGlobal("web_attr_1"); echo $__VALUE__; ?></a><p>
					</div>
				</div>
				...
				<div class="media media-x">
					...
					<div class="media-body">
						...
						<p class="text-middle"><a href="mailto:<?php  $tagGlobal = new \think\template\taglib\eyou\TagGlobal; $__VALUE__ = $tagGlobal->getGlobal("web_attr_15"); echo $__VALUE__; ?>"><?php  $tagGlobal = new \think\template\taglib\eyou\TagGlobal; $__VALUE__ = $tagGlobal->getGlobal("web_attr_15"); echo $__VALUE__; ?></a></p>
					</div>
				</div>
				<div class="blank-middle"></div>
			</div>
		...
		<div class="x3">
			...
			<div class="wx text-center">
				...
				<img src="<?php  $tagGlobal = new \think\template\taglib\eyou\TagGlobal; $__VALUE__ = $tagGlobal->getGlobal("web_attr_17"); echo $__VALUE__; ?>" alt="<?php  $tagGlobal = new \think\template\taglib\eyou\TagGlobal; $__VALUE__ = $tagGlobal->getGlobal("web_name"); echo $__VALUE__; ?>" class="img-responsive">
			</div>
		</div>
	</div>
</div>
...
<div class="layout">
	<div class="line home-contact">
			...
			<div class="gb">
				<div class="guestbook">
					<div class="title-block-c text-center">
						<!-- <h5 class="text-white"><?php echo $eyou['field']['typename']; ?></h5> -->
					...
					<form method="POST" <?php echo $field['formhidden']; ?> action="<?php echo $field['action']; ?>" onsubmit="return checkForm();">
						...
						<div class="form-group">
							<div class="field">
							<input type='text' id='attr_1' name='<?php echo $field['attr_1']; ?>' class="input text-main radius-none" placeholder="<?php echo $field['itemname_1']; ?>" value=""/>
							</div>
						</div>
						<!-- 电话 -->
						<div class="form-group">
							<div class="field">
							<input type='text' id='attr_2' name='<?php echo $field['attr_2']; ?>' class="input text-main radius-none" placeholder="<?php echo $field['itemname_2']; ?>" value=""/>
							</div>
						</div>
						...
						<div class="form-group">
							<div class="field">
							 <select name="<?php echo $field['attr_3']; ?>" id="attr_3">
							   <option value="">请选择<?php echo $field['itemname_3']; ?></option>
						...
						<div class="form-group">
							<div class="field"><textarea class="textarea" id='attr_24' name='<?php echo $field['attr_24']; ?>' placeholder="<?php echo $field['itemname_24']; ?>" value="" rows="3" /></textarea> </div>
						</div>
						<!-- 提交 -->
						<div class="blank"></div>
						<div class="form-button">
		...
		<div class="x6">
			<img src="<?php  $tagGlobal = new \think\template\taglib\eyou\TagGlobal; $__VALUE__ = $tagGlobal->getGlobal("web_templets_pc"); echo $__VALUE__; ?>/skin/images/ibkpic.jpg" alt='<?php echo $eyou['field']['title']; ?>' class="img-responsive" />
		</div>
	</div>
</div>
<!--网站公用底部——开始-->
