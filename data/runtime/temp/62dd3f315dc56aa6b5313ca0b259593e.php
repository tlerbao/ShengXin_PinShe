<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:44:"./application/admin/template/weapp/mybuy.htm";i:1613990304;s:67:"/www/ShengXin/YFMJSite/application/admin/template/public/layout.htm";i:1635510274;s:70:"/www/ShengXin/YFMJSite/application/admin/template/public/theme_css.htm";i:1635510274;s:67:"/www/ShengXin/YFMJSite/application/admin/template/public/footer.htm";i:1571728724;}*/ ?>
<!doctype html>
<html>
<head>
...
<div class="page">
    ...
    <div class="row-bar clearfix mb10">
        ...
        <div class="flexigrid fr">
            <form class="navbar-form form-inline" action="<?php echo url('Weapp/mybuy'); ?>" method="get" onsubmit="layer_loading('正在处理');">
                <?php echo (isset($searchform['hidden']) && ($searchform['hidden'] !== '')?$searchform['hidden']:''); ?>
                <div class="ftitle">
                    <div class="sDiv2 fl" style="margin-right: 6px;">
                        <input type="hidden" name="install" value="<?php echo (\think\Request::instance()->param('install') ?: 0); ?>">
                ...
                <div class="plug-item-content">
                    ...
                    <div class="plug-item-bottm">
                        <?php if(empty($vo['status']) || (($vo['status'] instanceof \think\Collection || $vo['status'] instanceof \think\Paginator ) && $vo['status']->isEmpty())): if(empty($vo['is_buy']) || (($vo['is_buy'] instanceof \think\Collection || $vo['is_buy'] instanceof \think\Paginator ) && $vo['is_buy']->isEmpty())): if(is_check_access('Weapp@install') == '1'): ?>
                                ...
                                <a href="javascript:void(0);" onclick="remoteInstall('<?php echo $vo['code']; ?>', '<?php echo (isset($vo['min_version']) && ($vo['min_version'] !== '')?$vo['min_version']:$vo['config']['min_version']); ?>');">安装</a>
...
<script>
    ...
    function delfun(obj){
        ...
        layer.confirm('将移除<font color="#ff0000">【'+name+'】</font>，确认移除？', {
            title: false,//name,
            btn: ['确定','取消'] //按钮
        }, function(){
            layer_loading('正在处理');
