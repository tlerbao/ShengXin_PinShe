<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:30:"./template/pc/lists_images.htm";i:1610521328;s:45:"/www/ShengXin/YFMJSite/template/pc/header.htm";i:1630027834;s:45:"/www/ShengXin/YFMJSite/template/pc/banner.htm";i:1610417126;s:45:"/www/ShengXin/YFMJSite/template/pc/footer.htm";i:1611804224;}*/ ?>
<!DOCTYPE html>
<html>
<head>
				...
				<div class="x4">
					<div class="media-img margin-large-bottom">
						<a href="<?php echo $field['arcurl']; ?>" target="_blank">
							...
							<div class="mask">
								<div class="subtitle">
									<h2 class="text-white text-big margin-bottom"><?php echo $field['title']; ?></h2>
									<p class="text-white"><?php echo $field['seo_description']; ?></p>
