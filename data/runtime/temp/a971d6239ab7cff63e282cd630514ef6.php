<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:29:"./template/pc/view_images.htm";i:1610615278;s:45:"/www/ShengXin/YFMJSite/template/pc/header.htm";i:1630027834;s:45:"/www/ShengXin/YFMJSite/template/pc/footer.htm";i:1611804224;}*/ ?>
<!DOCTYPE html>
<html>
<head>
...
<div class="layout bg-gray">
	<div class="container">
		<div class="line">
			<div class="nav-bread">
				<i class="fa fa-home margin-small-right"></i> <?php  $typeid = ""; if(empty($typeid) && isset($channelartlist["id"]) && !empty($channelartlist["id"])) : $typeid = intval($channelartlist["id"]); endif;  $tagPosition = new \think\template\taglib\eyou\TagPosition; $__VALUE__ = $tagPosition->getPosition($typeid, "", ""); echo $__VALUE__; ?>
			</div>
		</div>
	</div>
	<div class="container">
					...
					<div class="padding-large">
						<div class="post margin-big-bottom">
							...
							<div class="text-gray padding-big-bottom text-default">
								...
								<span class="margin-right">发布时间：<?php echo MyDate('Y-m-d',$eyou['field']['add_time']); ?></span>
						...
						<!-- 相册begin -->
							...
							<li>
							<img src="<?php echo $field['image_url']; ?>" class="img-responsive radius-middle" title="<?php echo $field['title']; ?>"/>
							</li>
				...
				<div class="prenext-pro">
					<div class="line">
						<div class="x5">
							...
							<a href="<?php echo $field['arcurl']; ?>" class="button button-block bg-white border radius-none text-main text-middle text-center" title="<?php  $tagLang = new \think\template\taglib\eyou\TagLang; $__VALUE__ = $tagLang->getLang('a:1:{s:4:"name";s:5:"sys10";}'); echo $__VALUE__; ?><?php echo $field['title']; ?>"><i class="margin-right fa fa-long-arrow-left"></i><?php echo $field['title']; ?></a>
							<?php else: ?>
							<a class="button button-block bg-white border radius-none text-gray text-middle text-center" title="<?php  $tagLang = new \think\template\taglib\eyou\TagLang; $__VALUE__ = $tagLang->getLang('a:1:{s:4:"name";s:5:"sys10";}'); echo $__VALUE__; ?>"><i class="margin-right fa fa-long-arrow-left"></i>没有了</a>
							<?php endif; $field = []; ?>
						</div>
						...
						<div class="x2 text-center">
							...
							<a href="<?php echo $field['typeurl']; ?>" class="button radius-none border button-block bg-white text-main text-middle text-center"><i class="fa fa-align-justify margin-right"></i><span class="hidden-l">返回列表</span></a>
						...
						<div class="x5">
							...
							<a href="<?php echo $field['arcurl']; ?>" class="button border button-block bg-white radius-none text-main text-middle text-center float-right" title="<?php echo $field['title']; ?>"><?php echo $field['title']; ?><i class="margin-left fa fa-long-arrow-right"></i></a>
							<?php else: ?>
