<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:46:"./application/admin/template/arctype/index.htm";i:1635510274;s:67:"/www/ShengXin/YFMJSite/application/admin/template/public/layout.htm";i:1635510274;s:70:"/www/ShengXin/YFMJSite/application/admin/template/public/theme_css.htm";i:1635510274;s:67:"/www/ShengXin/YFMJSite/application/admin/template/public/footer.htm";i:1571728724;}*/ ?>
<!doctype html>
<html>
<head>
                        ...
                        <td class="operation">
                            <div class="w300 tc pb0">
                                ...
                                <?php if(is_check_access('Arctype@add') == '1'): if(!empty($vo['weapp_code'])): ?>
                                    ...
                                    <?php endif; endif; ?>
                                <i></i>
                                <a href="<?php echo get_typeurl($vo); ?>" class="btn blue" target="_blank">浏览</a>
                            </div>
                        </td>
                        <td class="sort">
...
<script type="text/javascript">
    ...
    function delfun(obj){
        ...
        var confirm_title = '<font color="#ff0000">如有子栏目及文档将一起清空</font>，确认删除到回收站？';
        if ('del' == deltype) {
            confirm_title = '<font color="#ff0000">如有子栏目及文档将一起清空</font>，确认直接删除？';
        }
    ...
    if (typeid > 0) {
        ...
        <?php endif; if(!(empty($eyou['zzbaidutoken']) || (($eyou['zzbaidutoken'] instanceof \think\Collection || $eyou['zzbaidutoken'] instanceof \think\Paginator ) && $eyou['zzbaidutoken']->isEmpty()))): ?>
        // 百度自动推送
