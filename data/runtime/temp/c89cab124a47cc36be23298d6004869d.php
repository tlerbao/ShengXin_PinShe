<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:49:"./application/admin/template/uploadify/upload.htm";i:1635510274;}*/ ?>
<html lang="zh-cn">
<head>
    ...
    $(".statusBar .saveBtn").click(function(){
        ...
        if(callback != "undefined"){    
            ...
            try{
	            $.ajax({
	                type:'POST',
	                url:"<?php echo url('Uploadify/del_local', ['_ajax'=>1]); ?>",
	                data:{action:"del", filename:fileurl_tmp},
	                success:function(){}
	            });
            }catch(e){}
