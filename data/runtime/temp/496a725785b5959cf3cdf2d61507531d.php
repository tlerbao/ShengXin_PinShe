<?php if (!defined('THINK_PATH')) exit(); /*a:5:{s:43:"./application/admin/template/system/web.htm";i:1635510274;s:67:"/www/ShengXin/YFMJSite/application/admin/template/public/layout.htm";i:1635510274;s:70:"/www/ShengXin/YFMJSite/application/admin/template/public/theme_css.htm";i:1635510274;s:64:"/www/ShengXin/YFMJSite/application/admin/template/system/bar.htm";i:1611051758;s:67:"/www/ShengXin/YFMJSite/application/admin/template/public/footer.htm";i:1571728724;}*/ ?>
<!doctype html>
<html>
<head>
        ...
        <div class="ncap-form-default">
            ...
            <div id="div_web_status_close" class="<?php if(!isset($config['web_status']) OR empty($config['web_status'])): ?>none<?php endif; ?>">
                <dl class="row">
                    ...
                    <dd class="opt">
                        <input id="web_status_url" name="web_status_url" value="<?php echo (isset($config['web_status_url']) && ($config['web_status_url'] !== '')?$config['web_status_url']:''); ?>" class="input-txt" type="text" placeholder="关闭后，访问网站跳转的URL，http://" />
                ...
                <dl class="row">
                    ...
                    <dd class="opt">
                        <input id="web_status_tpl" name="web_status_tpl" value="<?php echo (isset($config['web_status_tpl']) && ($config['web_status_tpl'] !== '')?$config['web_status_tpl']:''); ?>" class="input-txt" type="text" placeholder="关闭后，访问网站显示的静态模板路径，public/close.html" />
...
<!-- 
            ...
            <dl class="row" id="dl_<?php echo $vo['attr_var_name']; ?>">
                ...
                <dd class="variable">
                    ...
                    <div class="r"><a href="javascript:void(0);" onclick="showtext('<?php echo $vo['attr_var_name']; ?>');" class="ui-btn3 blue <?php echo $vo['attr_var_name']; ?>" data-clipboard-text="{<?php  echo 'eyou:global name=\''; ?><?php echo $vo['attr_var_name'];  echo '\' /'; ?>}">复制标签</a></div>
                </dd>
                <?php endif; ?>
            </dl>
