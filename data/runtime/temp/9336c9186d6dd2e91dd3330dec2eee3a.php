<?php if (!defined('THINK_PATH')) exit(); /*a:5:{s:40:"./application/admin/template/seo/seo.htm";i:1635510274;s:67:"/www/ShengXin/YFMJSite/application/admin/template/public/layout.htm";i:1635510274;s:70:"/www/ShengXin/YFMJSite/application/admin/template/public/theme_css.htm";i:1635510274;s:61:"/www/ShengXin/YFMJSite/application/admin/template/seo/bar.htm";i:1611051758;s:67:"/www/ShengXin/YFMJSite/application/admin/template/public/footer.htm";i:1571728724;}*/ ?>
<!doctype html>
<html>
<head>
    ...
    <form method="post" id="handlepost" action="<?php echo url('Seo/handle'); ?>" enctype="multipart/form-data" name="form1">
        <div class="ncap-form-default">
            ...
            <dl class="row <?php if(empty($config['seo_pseudo']) || 1 != $config['seo_pseudo'] || (1 == $config['seo_pseudo'] && 1 == $config['seo_dynamic_format'])): ?>none<?php endif; ?>" id="dl_seo_dynamic_format">
                ...
                <dd class="opt">
                    <label><input type="radio" name="seo_dynamic_format" value="1" <?php if(!isset($config['seo_dynamic_format']) OR $config['seo_dynamic_format'] == 1): ?>checked="checked"<?php endif; ?>>完全兼容（<a href="javascript:void(0);" onclick="view_exp('view_1_1');">查看例子</a><span id="view_1_1" class="none">：http://yifan.test/index.php?m=home&amp;c=Lists&amp;a=index&amp;tid=1</span>）</label>&nbsp;
                    <?php if(isset($config['seo_dynamic_format']) AND $config['seo_dynamic_format'] == 2): ?>
                    <br/>
                    <label><input type="radio" name="seo_dynamic_format" value="2" checked="checked">部分兼容&nbsp;<font color="red">[部分空间不支持]</font>（<a href="javascript:void(0);" onclick="view_exp('view_1_2');">查看例子</a><span id="view_1_2" class="none">：http://yifan.test/home/Lists/index.html?tid=1</span>）</label>&nbsp;
                    <?php endif; ?>
                    <span class="err"></span>
                    <p class="notic"></p>
                </dd>
            ...
            <dl class="row <?php if(isset($config['seo_pseudo']) && $config['seo_pseudo'] != 3): ?>none<?php endif; ?>" id="dl_seo_rewrite_format">
                ...
                <dd class="opt">
                    <label>
                        <input type="radio" name="seo_rewrite_format" <?php if(!isset($config['seo_rewrite_format']) OR $config['seo_rewrite_format'] == 1): ?> value="1" checked="checked" <?php else: ?> value="3" checked="checked" <?php endif; ?>>目录名称（<a href="javascript:void(0);" onclick="view_exp('view_3_1');">示例</a><span id="view_3_1" class="none">：http://yifan.test/news/</span>）
                    </label>&nbsp;
                    <br/>
                    <label><input type="radio" name="seo_rewrite_format" value="2" <?php if(isset($config['seo_rewrite_format']) AND $config['seo_rewrite_format'] == 2): ?>checked="checked"<?php endif; ?>>模型标识（<a href="javascript:void(0);" onclick="view_exp('view_3_2');">示例</a><span id="view_3_2" class="none">：http://yifan.test/article/news.html</span>）</label>&nbsp;
                    <span class="err"></span>
                    <p class="notic"></p>
                </dd>
            </dl>
            <dl class="row <?php if(!isset($config['seo_pseudo']) OR $config['seo_pseudo'] != 3 OR $config['seo_rewrite_format'] == 2): ?>none<?php endif; ?>" id="dl_seo_rewrite_view_format">
                ...
                <dd class="opt">
                    <label><input type="radio" name="seo_rewrite_view_format" value="1" <?php if((!isset($config['seo_rewrite_format']) OR $config['seo_rewrite_format'] == 1) OR (!isset($config['seo_rewrite_view_format']) OR $config['seo_rewrite_view_format'] == 1)): ?>checked="checked"<?php endif; ?>>父目录</label>&nbsp;
                    <label><input type="radio" name="seo_rewrite_view_format" value="3" <?php if((isset($config['seo_rewrite_format']) AND $config['seo_rewrite_format'] == 3) OR $config['seo_rewrite_view_format'] == 3): ?>checked="checked"<?php endif; ?>>当前目录</label>&nbsp;
                    <span class="err"></span>
                    <p class="notic"></p>
                </dd>
            </dl>
            <dl class="row">
                ...
                <dd class="opt">
                    <label><input type="radio" name="seo_liststitle_format" value="1" <?php if(isset($config['seo_liststitle_format']) AND $config['seo_liststitle_format'] == 1): ?>checked="checked"<?php endif; ?>>栏目名称_第N页</label>&nbsp;
                    <br/>
